...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *TWITTER DOWNLOADER* 〕━━━𒊹︎︎︎\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *MEDIAFIRE DOWNLOADER* 〕━━━𒊹︎︎︎\n`
      + `┃▸ *File Name:* ${file_name}\n`
      + `┃▸ *File Type:* ${mime_type}\n`
      + `╰━━━𒊹︎︎︎\n\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *APK Downloader* 〕━━━┈𒊹︎︎︎
┃ 📦 *Name:* ${app.name}
┃ 🏋 *Size:* ${appSize} MB
┃ 📦 *Package:* ${app.package}
