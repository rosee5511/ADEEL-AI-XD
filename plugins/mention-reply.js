  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/pf9a6s.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "923174838990",
            body: config.DESCRIPTION || "𝐌ᴀғɪᴀ 𝐀ᴅᴇᴇʟ",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/pf9a6s.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/923174838990",
